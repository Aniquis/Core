Contributing to AniquisCoin Core
============================

The AniquisCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the AniquisCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/aniquiscoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to aniquiscoin-qt
...
The following applies to code changes to the AniquisCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall AniquisCoin
Network Protocol consensus changes.

Whether a pull request is merged into AniquisCoin Core rests with the project merge
...
Patches that change AniquisCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the AniquisCoin consensus, it must have been
...
The project leader is the release manager for each AniquisCoin Core release.
