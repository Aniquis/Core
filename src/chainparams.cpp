...
{
    const char* pszTimestamp = "Pen Pineapple Apple Pen";
    const CScript genesisOutputScript = CScript() << ParseHex("045092921055bd4bb6903f387e953af427840daa93d96c43ccd001ed307a7cb5bd26f34b92bde9b5f21d2db83128f6dea2ecda1376dbbafa3296fe66f8d74f8ea4") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0xa4d541a079d52ed210e4e409c84cb2a2923bd69d82368e38a32742859a8e9bb1"); 
        ...
        genesis = CreateGenesisBlock(1706994388, 2266536, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa4d541a079d52ed210e4e409c84cb2a2923bd69d82368e38a32742859a8e9bb1"));
        assert(genesis.hashMerkleRoot == uint256S("0x62b256f99cc7dcff85f2429f85891c500cb33b8b06662b9a9730e4ec27490677"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0xa4d541a079d52ed210e4e409c84cb2a2923bd69d82368e38a32742859a8e9bb1")},
            }
        };

        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 4096 a4d541a079d52ed210e4e409c84cb2a2923bd69d82368e38a32742859a8e9bb1
            /* nTime    */ 1706994388,
            /* nTxCount */ 0,
            /* dTxRate  */ 0
        };
...
public:
    CTestNetParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x3dffcfdeafd419301456be6f56f906ad062bb2ace5701e1fe295ab5f10ee6ef3"); 
        ...
        genesis = CreateGenesisBlock(1706994890, 660283, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3dffcfdeafd419301456be6f56f906ad062bb2ace5701e1fe295ab5f10ee6ef3"));
        assert(genesis.hashMerkleRoot == uint256S("0x62b256f99cc7dcff85f2429f85891c500cb33b8b06662b9a9730e4ec27490677"));
        ...
        checkpointData = {
            {
                {0, uint256S("3dffcfdeafd419301456be6f56f906ad062bb2ace5701e1fe295ab5f10ee6ef3")},
            }
        };

        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 3dffcfdeafd419301456be6f56f906ad062bb2ace5701e1fe295ab5f10ee6ef3
            /* nTime    */ 1706994890,
            /* nTxCount */ 0,
            /* dTxRate  */ 0,
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1706995042, 0, 0x207fffff, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00932351baaf11d3a58eafd8e2b8fd9d7da0d55a9999408c6f99df4918ab3d84"));
        assert(genesis.hashMerkleRoot == uint256S("0x62b256f99cc7dcff85f2429f85891c500cb33b8b06662b9a9730e4ec27490677"));
        ...
        checkpointData = {
            {
                {0, uint256S("00932351baaf11d3a58eafd8e2b8fd9d7da0d55a9999408c6f99df4918ab3d84")},
            }
        };
