...
bech32_templates = [
  ...
  ('anqs',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('anqs',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('anqs',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('anqs',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tanqs',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tanqs',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tanqs',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tanqs',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tanqs',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tanqs',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tanqs',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tanqs',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('ranqs',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ranqs',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ranqs',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('ranqs', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tanqs',   17, 32, Encoding.BECH32M, False, False, False),
  ('ranqs',  3,  1, Encoding.BECH32M, False, False, False),
  ('anqs',   15, 41, Encoding.BECH32M, False, False, False),
  ('tanqs',    0, 16, Encoding.BECH32,  False, False, False),
  ('ranqs',  0, 32, Encoding.BECH32,  True,  False, False),
  ('anqs',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tanqs',    0, 32, Encoding.BECH32,  False, True,  False),
  ('ranqs',  0, 20, Encoding.BECH32,  False, False, True),
  ('anqs',    0, 20, Encoding.BECH32M, False, False, False),
  ('tanqs',    0, 32, Encoding.BECH32M, False, False, False),
  ('ranqs',  0, 20, Encoding.BECH32M, False, False, False),
  ('anqs',    1, 32, Encoding.BECH32,  False, False, False),
  ('tanqs',    2, 16, Encoding.BECH32,  False, False, False),
  ('ranqs', 16, 20, Encoding.BECH32,  False, False, False),
]
