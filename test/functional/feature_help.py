...
"""Verify that starting aniquiscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aniquiscoin with -h for help text")
        ...
        self.log.info("Start aniquiscoin with -version for version information")
        ...
        self.log.info("Start aniquiscoind with -fakearg to make sure it does not start")
