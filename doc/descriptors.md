# Support for Output Descriptors in AniquisCoin Core

Since AniquisCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `anqs1...` for mainnet or `tanqs1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing AniquisCoin Core wallets, a convenience function `combo` is
